...
describe("UserDetailModal Component", () => {
  it("does not render modal content when `open` is false", () => {
    render(<UserDetailModal open={false} onClose={mockOnClose} modalData={mockModalData} />);

    expect(screen.queryByText("User Details")).not.toBeInTheDocument();
  });
  it("renders the modal with user details correctly when open", () => {
    render(<UserDetailModal open={true} onClose={mockOnClose} modalData={mockModalData} />);
    ...
    expect(screen.getByText("Company Department")).toBeInTheDocument();
